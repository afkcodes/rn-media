 ...
 * the same constraint that forced `defaultMode` in `@afkcodes/timbre-audio-session`.
 */
...
export type MediaControl =
   ...
   * collision that forced `defaultMode` in `@afkcodes/timbre-audio-session`. Swift may
