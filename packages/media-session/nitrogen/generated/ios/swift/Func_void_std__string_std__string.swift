...
/**
 * Wraps a Swift `(_ name: String, _ extras: String) -> Void` as a class.
...
public final class Func_void_std__string_std__string {
  ...
  private let closure: (_ name: String, _ extras: String) -> Void

  public init(_ closure: @escaping (_ name: String, _ extras: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(name: std.string, extras: std.string) -> Void {
    self.closure(String(name), String(extras))
  }
