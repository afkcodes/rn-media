...
/**
 * Wraps a Swift `(_ position: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.rnmediamediasession.bridge.swift

  private let closure: (_ position: Double) -> Void

  public init(_ closure: @escaping (_ position: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(position: Double) -> Void {
