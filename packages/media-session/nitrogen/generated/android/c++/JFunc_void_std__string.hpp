...
namespace margelo::nitro::rnmediamediasession {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnmediamediasession/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnmediamediasession/Func_void_std__string_cxx;";
