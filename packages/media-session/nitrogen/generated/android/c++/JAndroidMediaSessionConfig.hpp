...
namespace margelo::nitro::rnmediamediasession {
  ...
  public:
    ...
    AndroidMediaSessionConfig toCpp() const {
      ...
      static const auto fieldNotificationColor = clazz->getField<jni::JDouble>("notificationColor");
      jni::local_ref<jni::JDouble> notificationColor = this->getFieldValue(fieldNotificationColor);
      return AndroidMediaSessionConfig(
        ...
        notificationColor != nullptr ? std::make_optional(notificationColor->value()) : std::nullopt
      );
    }
  ...
  public:
    ...
    static jni::local_ref<JAndroidMediaSessionConfig::javaobject> fromCpp(const AndroidMediaSessionConfig& value) {
      using JSignature = JAndroidMediaSessionConfig(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jboolean, jni::alias_ref<jni::JDouble>, jboolean, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.notificationColor.has_value() ? jni::JDouble::valueOf(value.notificationColor.value()) : nullptr
      );
    }
  };
