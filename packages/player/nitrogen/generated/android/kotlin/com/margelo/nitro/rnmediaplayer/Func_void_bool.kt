...
/**
 * Represents the JavaScript callback `(interactive: boolean) => void`.
...
fun interface Func_void_bool: (Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(interactive: Boolean): Unit
}
...
class Func_void_bool_cxx: Func_void_bool {
  ...
  @Keep
  override fun invoke(interactive: Boolean): Unit
    = invoke_cxx(interactive)

  private external fun invoke_cxx(interactive: Boolean): Unit
}
...
class Func_void_bool_java(private val function: (Boolean) -> Unit): Func_void_bool {
  ...
  @Keep
  override fun invoke(interactive: Boolean): Unit {
    return this.function(interactive)
  }
}
