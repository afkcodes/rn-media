...
Every ✅ in the `rn-media` column is a claim this repo has to be able to prove:
...
| Casting, Android device-verified / iOS device pass pending | [`@rn-media/cast`](../packages/cast/README.md) |
...
screens and background survival. They compose: `@rn-media/media-session` takes
