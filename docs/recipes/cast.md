...
driving a Chromecast, so `@rn-media/cast` pauses your player, hands the receiver
...
| The handoff lives in `@rn-media/cast` | `media-session` stays player-agnostic and cast-free in both directions |
